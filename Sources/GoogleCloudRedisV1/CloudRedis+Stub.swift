...
extension Clients {
  ...
  class CloudRedisTransport: CloudRedisStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://redis.googleapis.com")
    }
    ...
    public func listInstances(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudRedisV1.ListInstancesResponse.self, from: data)
    }
    ...
    public func getInstance(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudRedisV1.Instance.self, from: data)
    }
    ...
    public func getInstanceAuthString(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/authString"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudRedisV1.InstanceAuthString.self, from: data)
    }
